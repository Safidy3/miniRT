...
OBJECTS_SRCS = ./objects/create_objects.c ./objects/obj_light.c ./objects/obj_camera.c ./objects/thread_copy_world.c\
				./objects/obj_cylinder.c ./objects/obj_plane.c ./objects/obj_sphere.c ./objects/obj_cone.c
...
SRCS = main.c data_free.c  print_debug.c\
